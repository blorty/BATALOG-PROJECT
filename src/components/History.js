...
function History() {
    return (
        <div className="App min-h-screen min-w-full animate-moveGradient container mx-auto flex flex-col items-center justify-center p-4">
            ...
            <p className="text-white pt-3.5 pb-3.5 max-w-screen-lg text-2xl text-center mb-8 rounded-lg bg-gray-600 p-4 opacity-80" style={{ paddingLeft: "1rem", paddingRight: "1rem" }}>
